...
void print_all_elements(stack_t **head, unsigned int number);
void print_top_element(stack_t **head, unsigned int number);
int execute(char *content, stack_t **head, unsigned int counting, FILE *file);
...
void add_top_two_elements(stack_t **head, unsigned int counting);
void f_nop(stack_t **head, unsigned int counting);
void subtract_top_two_elements(stack_t **head, unsigned int counting);
void divide_top_two_elements(stack_t **head, unsigned int counting);
...
void rotate_left(stack_t **head, unsigned int counting);
...
void switch_to_stack(stack_t **head, unsigned int counting);
